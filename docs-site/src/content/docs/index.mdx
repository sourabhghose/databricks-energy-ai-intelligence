...
hero:
  ...
  actions:
    - text: Get Started
      link: /databricks-energy-copilot/getting-started/overview
      icon: right-arrow
      variant: primary
    - text: View on GitHub
      link: https://github.com/sourabhghose/databricks-energy-copilot
      icon: external
      variant: secondary
---
...
<CardGrid>
  <Card title="564 Pages" icon="document">
  ...
  <Card title="64 Routers / 636+ Endpoints" icon="setting">
  ...
  <Card title="51 AI Tools" icon="star">
    Claude Sonnet 4.5 via Databricks Foundation Model API with 51 tools covering market data retrieval, ML forecasting, trading analysis, risk management, and DNSP operations.
  </Card>
  <Card title="12 Genie Spaces" icon="open-book">
  ...
  <Card title="30 Pipeline Jobs" icon="rocket">
  ...
  <Card title="108+ Gold Tables" icon="list-format">
    Unity Catalog medallion lakehouse with 108+ curated Gold Delta tables feeding real-time dashboards and ML models with sub-10ms query latency via Lakebase.
  </Card>
</CardGrid>
...
<CardGrid>
  <LinkCard
    ...
    href="/databricks-energy-copilot/ai-ml/copilot"
  />
  <LinkCard
    ...
    href="/databricks-energy-copilot/front-office/live-market"
  />
  <LinkCard
    ...
    href="/databricks-energy-copilot/dnsp/overview"
  />
  <LinkCard
    ...
    href="/databricks-energy-copilot/ai-ml/overview"
  />
</CardGrid>
